...
API_ID = 23972792 # api_id
API_HASH = '32990f945dae5ae0bc3f702b1caef65a' #Api_hash
SEND_CHAT = '@FuckCcH' # يوزر القناه او الشات 
...
chats = [
  '@LalaScrap', '@anyascrapper', '@ScrappFHXZfree', '@anabellescrappe',
  '@VegetaScrap', '@teamnastyscr','@ScrappCodex','@JennaScrap','@BlindScrap','@ReiAyanamiChat','@authcard','@OficialScorpionsGrupo','@makimascra','@savagegroupoficial','@BinSkillerChat','@TechzillaCheckerChat'
]
